...
class BotConfig:
    ...
    OPENAI_ANALYSIS_THRESHOLD: float = 0.7  # Порог для определения нарушения (0-1)
...
2. Содержит ли нарушения правил общения
3. Есть ли оскорбления или неуважительное отношение
